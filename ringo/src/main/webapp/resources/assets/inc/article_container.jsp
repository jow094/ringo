		...
		<div class="main_card_body unity_main_container">
			<div class="scroll_box">
				<div class="unity_menu">
					<div class="menu_tag" onclick="col_toggle($(this).next('.favorite_unities'),$(this).find('i').last())">
						<span>즐겨찾기</span>
				...
				<div class="scroll_box_inner">
					<div class="unity_content">
						...
						<div class="menu_tag" onclick="col_toggle($(this).next('.unities_container'),$(this).find('i').last())">
							<span>추천 유니티</span>
							<i class="fas fa-chevron-circle-up"></i>
						</div>
